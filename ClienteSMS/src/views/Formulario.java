...
public class Formulario extends JFrame {
	...
	public Formulario() throws FileNotFoundException {
		...
		lblNome.setBounds(10, 35, 47, 14);
		contentPane.add(lblNome);

		textField = new JTextField();
		textField.setBounds(67, 32, 200, 20);
		...
		btnNewButton.setBounds(67, 180, 200, 23);
		contentPane.add(btnNewButton);

		JLabel lblNmero = new JLabel("N\u00FAmero:");
		lblNmero.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNmero.setBounds(10, 63, 50, 14);
		contentPane.add(lblNmero);

		textField_1 = new JTextField();
		textField_1.setBounds(67, 60, 200, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);

		JLabel lblTexto = new JLabel("Texto:");
		lblTexto.setHorizontalAlignment(SwingConstants.RIGHT);
		lblTexto.setBounds(10, 88, 47, 14);
		contentPane.add(lblTexto);

		textArea = new JTextArea();
		textArea.setRows(5);
		textArea.setBounds(67, 91, 200, 78);
	...
	public void enviarsms() throws IOException {
		try {
			 ...
			 Properties prop = configuracoes.GetProp();
